    ...
    render(){
        ...
        return(
            <form onSubmit={handleSubmit} className="w-50">
                ...
                <Field name="nombre_seccion" component={renderField} disabled={disabled}/>
                <br/>
                
            
                <div className="d-flex flex-row justify-content-end mt-2">
                    <a href="/#/seccion" className="btn btn-secondary btn-sm mr-2">Cancelar</a>
...
export default reduxForm({
    form: 'seccionForm' // Identificar unico del formulario
