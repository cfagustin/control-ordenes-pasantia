...
/**
 * ESTE ARCHIVO VA A CONECTAR CON LA ESTRUCTURA DE REDUX
 */

// Importar connect del modulo de react-redux
...
import CalificarTareaCrear from './CalificarTareaCrear';
 ...
 */
export default connect(ms2p, md2p)(CalificarTareaCrear);